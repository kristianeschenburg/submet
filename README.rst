...
Given two subspaces, :math:`$X$` and :math:`$Y$`, each of dimension :math:`$p$`, the distance between the two subspaces is depndent on the singular values, :math:`$\sigma_{1}... \sigma_{p}$` of their inner product.
